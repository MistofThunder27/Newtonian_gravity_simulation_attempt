...
test_start_state = {
    ...
    "obj2": [[1e10, -10, 0, 0, 0], "green", 1],
    "obj3": [[1e10, 0, 10, 0, -0.0125], "blue", 1]
}
...
def update_state():
    ...
    for object1_name in global_state:
        ...
        object1_properties = global_state[object1_name][0]
        ...
        if len(obj_pos_his) > history_record_length - 1:
            obj_pos_his.pop(0)
        ...
        for object2_name in global_state:
            if object1_name != object2_name:
                ...
                object2_properties = global_state[object2_name][0]
...
def update_display():
    ...
    for object_name in global_state:
        object_properties = global_state[object_name][0]
